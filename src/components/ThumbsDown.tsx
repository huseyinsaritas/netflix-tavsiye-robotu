    ...
    <TouchableOpacity onPress={onPress} style={styles.thumbsDown} activeOpacity={0.8}>
      <Svg width={width} height={width} enable-background="new 0 0 300 300" viewBox="0 0 300 300">
        <G transform="matrix(-1 0 0 1 300 0)">
          ...
          <Path fill="#4C241D" d="m242.213 172h-50.135c-2.209 0-4-1.791-4-4s1.791-4 4-4h50.135c5.354 0 9.709-4.263 9.709-9.503v-.704c0-5.24-4.355-9.503-9.709-9.503h-52.582c-2.209 0-4-1.791-4-4s1.791-4 4-4h52.582c9.765 0 17.709 7.852 17.709 17.503v.704c0 9.651-7.944 17.503-17.709 17.503z"/>
          ...
          <Path fill="#4C241D" d="m242.213 144.424h-53.582c-2.209 0-4-1.791-4-4s1.791-4 4-4h53.582c5.354 0 9.709-4.355 9.709-9.709v-.715c0-5.354-4.355-9.709-9.709-9.709h-52.582c-2.209 0-4-1.791-4-4s1.791-4 4-4h52.582c9.765 0 17.709 7.944 17.709 17.709v.714c0 9.765-7.944 17.71-17.709 17.71z" />
          <Path fill="#edebdc" d="m185.922 112.291h44c7.732 0 14-6.268 14-14 0-7.732-6.268-14-14-14h-44" />
          <G fill="#4c241d">
            <Path fill="#4C241D" d="m229.922 116.291h-44c-2.209 0-4-1.791-4-4s1.791-4 4-4h44c5.514 0 10-4.486 10-10s-4.486-10-10-10h-44c-2.209 0-4-1.791-4-4s1.791-4 4-4h44c9.925 0 18 8.075 18 18s-8.075 18-18 18z" />
